 ...
 */
public final class estimate_profit_itemwise extends javax.swing.JInternalFrame {
    ...
    final void button_short() {
        ...
        titlelablel.setText("<html><u>Estimate Item Wise Profit</u></html>");
        jLabel12.setText(
                "<html><u>Info:</u> Profit Calculations not includes Tax Amount, Transport Amount , Other Charges</html>");
        setTitle("Estimate Item Wise Profit");
    ...
    void load_report(String dfrom, String dto) {
        try {
            ...
            if (all.isSelected()) {
                query = "select a.ino,a.iname,sum(quan),sum(sub),sum(cost_rate),sum(profit) from estimate_items a,item b where dat between ? and ? and a.ino=b.ino group by a.ino, a.iname order by sum(profit) desc";
                ps = conn.prepareStatement(query);
                ps.setString(1, lk);
                ps.setString(2, lk1);
            } else {
                query = "select a.ino,a.iname,sum(quan),sum(sub),sum(cost_rate),sum(profit) from estimate_items a,item b where dat between ? and ? and cat=? and a.ino=b.ino group by a.ino, a.iname order by sum(profit) desc";
                ps = conn.prepareStatement(query);
                ps.setString(1, lk);
                ps.setString(2, lk1);
    ...
    public estimate_profit_itemwise(DataUtil util) {
        initComponents();
    ...
    private void initComponents() {
        ...
        titlelablel.setText("Estimate Item Wise Profit");
    ...
    private void excelbuttonActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_excelbuttonActionPerformed
        ...
        try {
            ...
            String file_name = "EstimateItemWiseProfit.xlsx";
