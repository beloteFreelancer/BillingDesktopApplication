 ...
 */
public class estimate_profit_daywise extends javax.swing.JInternalFrame {
    ...
    final void button_short() {
        ...
        titlelablel.setText("<html><u>Estimate Day Wise Profit</u></html>");
        setTitle("Estimate Day Wise Profit");
    ...
    void load_report(String dfrom, String dto) {
        try {
            ...
            String query;
            query = "select date_format(dat,'%d/%m/%Y'),min(billno),max(billno),count(billno),sum(gross),sum(cost_rate),sum(gross-cost_rate) from estimate where dat between '"
            ...
            while (r.next()) {
                ...
                s2.addRow(new Object[] { r.getString(1), r.getString(2) + " -" + r.getString(3), r.getString(4), sub,
                        cost_rate, profit });
                selva = true;
            }
    ...
    public estimate_profit_daywise(DataUtil util) {
        initComponents();
    ...
    private void initComponents() {
        ...
        titlelablel.setText("Estimate Day Wise Profit");
    ...
    private void excelbuttonActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_excelbuttonActionPerformed
        ...
        try {
            ...
            try (FileWriter f = new FileWriter(new File(folder + "/Drafts/" + file_name + ".xls"))) {
                f.write("Estimate Day Wise Profit:\n");
