 ...
 */
public class estimate_profit_billwise extends javax.swing.JInternalFrame {
    ...
    final void button_short() {
        ...
        titlelablel.setText("<html><u>Estimate Bill Wise Profit</u></html>");
        jLabel12.setText(
                "<html><u>Info:</u> Profit Calculations not includes Tax Amount, Transport Amount , Other Charges</html>");
        setTitle("Estimate Bill Wise Profit");
    ...
    void load_report(String dfrom, String dto) {
        try {
            ...
            boolean selva = false;
            String query;
            query = "select date_format(dat,'%d/%m/%Y'),billno,cname,gross,cost_rate,gross-cost_rate from estimate where dat between '"
    ...
    public estimate_profit_billwise(DataUtil util) {
        initComponents();
    ...
    private void initComponents() {
        ...
        titlelablel.setText("Estimate Bill Wise Profit");
    ...
    private void excelbuttonActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_excelbuttonActionPerformed
        ...
        try {
            ...
            try (FileWriter f = new FileWriter(new File(folder + "/Drafts/" + file_name + ".xls"))) {
                f.write("Estimate Bill Wise Profit:\n");
