    ...
    void load_report() {
        try {
            ...
            if (all.isSelected()) {
                ...
                query = "select billno,date_format(dat,'%d/%m/%Y'),date_format(ddate,'%d/%m/%Y'),a.cid,a.cname,tot,paid from cust_bal a,cust b where city='"
                        + h3.getSelectedItem() + "' and tot-paid>0 and a.cid=b.cid order by city,dat,billno";
            }
