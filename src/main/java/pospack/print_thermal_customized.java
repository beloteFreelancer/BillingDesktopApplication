    ...
    public void Report(DataUtil util, String billno, String drive, String folder, String billformat) {
        try {
            ...
            String companyWhere = UserSession.hasSelectedCompany()
                    ...
                    : "";
            String query = "select cname,add1,add2,add3,bhead,sms1,sms2,sms3,hmany,letter,logo_path,upi_id,add4 from company"
                    + companyWhere;
            ...
            JasperReport jasperReport = JasperReportCompiler
                    .compileReport("/JasperFiles/Thermal_Unicode/Thermal_GST_Customized.jrxml");
