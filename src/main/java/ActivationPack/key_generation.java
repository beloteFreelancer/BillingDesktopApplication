...
public final class key_generation extends javax.swing.JFrame {
    ...
    void save() {
        try {
            ...
            for (int i = 0; i < jTable1.getRowCount(); i++) {
                ...
                s.addBatch("insert into call_logs values ('" + sno + "','" + date + "','" + time + "','" + key + "','"
                        + status + "','" + entry_no + "','" + cid + "','" + keydetails + "','" + user + "','" + last
                        + "')");
                sno++;
            } // for loop ends
        ...
        layout.setHorizontalGroup(
                layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(layout.createSequentialGroup()
                                .addComponent(jPanel1, javax.swing.GroupLayout.PREFERRED_SIZE, 454,
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(key_generation.class.getName()).log(java.util.logging.Level.SEVERE, null,
                    ex);
        }
